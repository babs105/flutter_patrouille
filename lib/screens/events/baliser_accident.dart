...
class BaliserAccident extends StatefulWidget {
  final event;
  BaliserAccident({this.event});

  @override
  _BaliserAccidentState createState() => _BaliserAccidentState();
}

class _BaliserAccidentState extends State<BaliserAccident> {
